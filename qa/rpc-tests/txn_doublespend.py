...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 BitHao:
        ...
        # First: use raw transaction API to send 12400 BitHao to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 BitHao coin each
        ...
        # Node0's balance should be starting balance, plus 500BitHao for another
        ...
        # Node0's total balance should be starting balance, plus 1000BitHao for
