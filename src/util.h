 ...
 */
#ifndef BITHAO_UTIL_H
#define BITHAO_UTIL_H
...
//#define ENABLE_BITHAO_DEBUG
#ifdef ENABLE_BITHAO_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const BITHAO_CONF_FILENAME;
extern const char * const BITHAO_PID_FILENAME;
...
{
    std::string s = strprintf("bithao-%s", name);
