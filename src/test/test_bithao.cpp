...
#define BOOST_TEST_MODULE BitHao Test Suite

#include "test_bithao.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bithao_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
