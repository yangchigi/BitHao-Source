...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all BitHao related functionality
...
/*
    ...
    allow endless transaction that would bloat BitHao and make it unusable. To
