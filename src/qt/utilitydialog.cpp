    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitHao Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitHao Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bithao-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        std::string strUsage = HelpMessage(HMM_BITHAO_QT);
...
All the BitHao in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BitHao, 0.1 BitHao, 1 BitHao and 10 BitHao -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bithaopay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bithaopay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitHao Core is shutting down...") + "<br /><br />" +
