    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitHao Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #dc4b4b, stop: 1 #e5063e); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitHao address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bithao: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitHao Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitHao Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitHao Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitHao addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitHao addresses"));
    ...
    openAction->setStatusTip(tr("Open a bithao: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitHao Core help message to get a list with possible BitHao Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitHao Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitHao network", "", count));
    } else {
...
{
    QString strTitle = tr("BitHao Core"); // default title
