...
#ifndef BITHAO_QT_BITCOINUNITS_H
#define BITHAO_QT_BITCOINUNITS_H
...
/** BitHao unit definitions. Encapsulates parsing and formatting
...
#endif // BITHAO_QT_BITCOINUNITS_H
