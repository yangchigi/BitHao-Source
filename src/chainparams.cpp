...
{
    const char* pszTimestamp = "I love BITHAO I love world";
    const CScript genesisOutputScript = CScript() << ParseHex("04a1da2c490c1c06a635236e045fa33cf1ef32959b9c2be675a1224cf751f638b1d23be57fc5cfcd09b4bda886c1b48848fa86c08cef57ab7388d7c24250d38910") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256(); // consensus.BIP34Hash = uint256S("0x0000000319f64f5a0d068d82efb8ce0843f20b3a56fee1bf04707ff92fc484d7");
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 30.0 * 60; // BitHao: 1 day
        consensus.nPowTargetSpacing = 0.5 * 60; // BitHao: 2 minutes
        ...
        genesis = CreateGenesisBlock(1542616573, 1000158003, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f932d857f4cf7b86376a18a3717d39aa7dc46eba56c81f06971f7a5993f"));
        assert(genesis.hashMerkleRoot == uint256S("0xc0197e1400e2bd848a7b8d173f38de11ab656bac2bb8f581562885f8b6e5eab4"));

        vSeeds.push_back(CDNSSeedData("207.148.114.146", "207.148.114.146"));
        vSeeds.push_back(CDNSSeedData("45.32.34.72", "45.32.34.72"));

        // BitHao addresses start with 'M'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        // BitHao script addresses start with 'W'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,73);
        // BitHao private keys start with 'Y' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,77);
        // BitHao BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // BitHao BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // BitHao BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x00000f932d857f4cf7b86376a18a3717d39aa7dc46eba56c81f06971f7a5993f"))
			,
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 30.0 * 60; // bithao: 1 day
        consensus.nPowTargetSpacing = 0.5 * 60; // bithao: 2.5 minutes
        ...
        genesis = CreateGenesisBlock(1542616572, 135818, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000cd65d4da0f5c3b2589cf963c27c251901caed54f2fa9eea4da6dcc1e141"));
        assert(genesis.hashMerkleRoot == uint256S("c0197e1400e2bd848a7b8d173f38de11ab656bac2bb8f581562885f8b6e5eab4"));
        ...
        // Testnet BitHao addresses start with 'y' or 'x'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,139);
        // Testnet BitHao script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet BitHao BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet BitHao BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet BitHao BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000cd65d4da0f5c3b2589cf963c27c251901caed54f2fa9eea4da6dcc1e141")),
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1542616571, 194529, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000a1d278d41d0625676f48a8f91de00485a42da2bd3aea2b430b9c80aba12"));
        assert(genesis.hashMerkleRoot == uint256S("0xc0197e1400e2bd848a7b8d173f38de11ab656bac2bb8f581562885f8b6e5eab4"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x00000a1d278d41d0625676f48a8f91de00485a42da2bd3aea2b430b9c80aba12")),
            0,
            0,
            0
        };
        // Regtest BitHao addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest BitHao script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest BitHao BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest BitHao BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest BitHao BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
