...
This mechanism has been integrated into Bitcore-Node-BitHao which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bithaopay/insight-api-bithao#web-socket-api](https://github.com/bithaopay/insight-api-bithao#web-socket-api)
* API: [https://github.com/bithaopay/insight-api-bithao#instantsend-transactions](https://github.com/bithaopay/insight-api-bithao#instantsend-transactions)
...
By default, the BitHao Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitHao Core daemon:
