...
Only requiring some minor changes is bithao.cpp.
...
Changes to bithao.cpp
----------------------
bithao.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
